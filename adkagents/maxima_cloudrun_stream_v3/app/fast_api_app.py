...
DEFAULT_AGENT_ENGINE_SESSION_NAME = "maxima-cloudrun-stream-v3-sessions"
...
app.title = "maxima-cloudrun-stream-v3"
app.description = "Cloud Run ADK runtime for the Maxima streaming v3 agent."
